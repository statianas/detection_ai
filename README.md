...
2) Before starting, you need to clear all received files using "processing_files.py", put your directory with files from previous step to function in it. We will delete those that are known to be broken. 
